...
export default function ContactUsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        showSuccess(result.message || 'Thank you for your message! We will get back to you within 24 hours.');
        // Reset form
        setFormData({
          name: '',
          email: '',
        ...
        showError(result.error || 'Failed to send your message. Please try again.');
      }
    } catch (error) {
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <input 
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-3 rounded-r-lg border-t border-b border-r border-gray-300 text-[#232f53] bg-white focus:outline-none focus:ring-2 focus:ring-[#232f53] text-base font-medium" 
